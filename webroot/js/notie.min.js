    ...
    (function (e) {
      ...
      !function (c, o) {
        ...
        return function (e) {
          ...
          var a = "function" == typeof Symbol && "symbol" === i(Symbol.iterator)
              ? function (e) {
            ...
            v = function () {
              return r.transitionSelector + " " + r.transitionDuration + "s " +
                r.transitionCurve;
            },
            b = function (e) {
              return 13 === e.keyCode;
            ...
            g = function (e, t) {
              ...
              n.id = r.ids.overlay,
                ...
                n.style.opacity = 0,
                e && r.overlayClickDismiss && (n.onclick = function () {
                  L(e.id, t), h();
                }),
            ...
            C = t.alert = function (e) {
              ...
              v.id = g,
                ...
                v.innerHTML = '<div class="' + r.classes.textboxInner + '">' +
                  s + "</div>",
                v.onclick = function () {
                  return L(g, d);
                },
            ...
            E = t.force = function (e, t) {
              ...
              x.classList.add(r.classes.textbox),
                ...
                x.innerHTML = '<div class="' + r.classes.textboxInner + '">' +
                  a + "</div>";
            ...
            T = t.confirm = function (e, t, n) {
              ...
              E.classList.add(r.classes.textbox),
                ...
                E.innerHTML = '<div class="' + r.classes.textboxInner + '">' +
                  s + "</div>";
            ...
            M = function (e, t, n) {
              ...
              H.classList.add(r.classes.textbox),
                ...
                H.innerHTML = '<div class="' + r.classes.textboxInner + '">' +
                  i + "</div>";
              ...
              S.classList.add(r.classes.inputField),
                ...
                S.value = E.value || "",
                E.allowed && (S.oninput = function () {
                  var e = void 0;
                  if (Array.isArray(E.allowed)) {
                    for (var t = "", n = E.allowed, s = 0; s < n.length; s++) {
                      "an" === n[s]
                        ? t += "0-9a-zA-Z"
                        : "a" === n[s]
                        ? t += "a-zA-Z"
          ...
          var H = t.select = function (e, t) {
            ...
            S = t.date = function (e, t, n) {
              ...
              var C = "&#9662",
                ...
                S = function (e) {
                  var t = new Date(a.getFullYear(), a.getMonth() + 1, 0)
                      .getDate(),
                    n = e.target.textContent.replace(/^0+/, "").replace(
                      /[^\d]/g,
                      "",
                    ).slice(0, 2);
                ...
                w = function (e) {
                  var t = e.target.textContent.replace(/^0+/, "").replace(
                    /[^\d]/g,
                    "",
                  ).slice(0, 4);
                ...
                A = function (e) {
                  var t = new Date(a.getFullYear(), a.getMonth() + e + 1, 0)
                    .getDate();
                ...
                I = function (e) {
                  ...
                  t < 0 ? a.setFullYear(0) : a.setFullYear(a.getFullYear() + e),
                    H(a);
                },
