...
function CodeJar(t, e, n = {}) {
  ...
  const u = (t, n) => {
    ...
    p = r.navigator.userAgent.match(/Firefox\/([0-9]+)\./),
    h = p ? parseInt(p[1]) : 0;
  let g = !1;
  ("plaintext-only" !== t.contentEditable || h >= 136) && (g = !0),
    g && t.setAttribute("contenteditable", "true");
  const y = H(() => {
    const e = b();
    u(t, e), E(e);
  }, 30);
  let N = !1;
  const m = (t) =>
      !S(t) && !A(t) && "Meta" !== t.key && "Control" !== t.key &&
      "Alt" !== t.key && !t.key.startsWith("Arrow"),
    C = H((t) => {
      m(t) && (O(), N = !1);
    }, 300),
    T = (e, n) => {
  ...
  function b() {
    const e = _(), n = { start: 0, end: 0, dir: void 0 };
    let { anchorNode: o, anchorOffset: r, focusNode: s, focusOffset: a } = e;
    if (!o || !s) throw "error1";
    if (o === t && s === t) {
      return n.start = r > 0 && t.textContent ? t.textContent.length : 0,
        n.end = a > 0 && t.textContent ? t.textContent.length : 0,
        n.dir = a >= r ? "->" : "<-",
        n;
    }
    ...
    if (s.nodeType === Node.ELEMENT_NODE) {
      const t = i.createTextNode("");
      s.insertBefore(t, s.childNodes[a]), s = t, a = 0;
    }
    return M(t, (t) => {
      if (t === o && t === s) {
        return n.start += r, n.end += a, n.dir = r <= a ? "->" : "<-", "stop";
      }
      if (t === o) {
        if (n.start += r, n.dir) return "stop";
        n.dir = "->";
      } else if (t === s) {
        if (n.end += a, n.dir) return "stop";
        n.dir = "<-";
      }
  ...
  function E(e) {
    ...
    M(t, (t) => {
      ...
      if (d + n > e.start && (o || (o = t, s = e.start - d), d + n > e.end)) {
        return r = t, a = e.end - d, "stop";
      }
      d += n;
    }),
      o || (o = t, s = t.childNodes.length),
      r || (r = t, a = t.childNodes.length),
      "<-" == e.dir && ([o, s, r, a] = [r, a, o, s]);
    {
      const t = x(o);
      if (t) {
      ...
      if (e) {
        const t = i.createTextNode("");
        e.parentNode?.insertBefore(t, e), r = t, a = 0;
      }
    }
    n.setBaseAndExtent(o, s, r, a), t.normalize();
  }
  function x(e) {
    for (; e && e !== t;) {
  ...
  function w() {
    const e = _().getRangeAt(0), n = i.createRange();
  ...
  function _() {
    return t.getRootNode().getSelection();
  }
  return T("keydown", (e) => {
    e.defaultPrevented || (d = P(),
      o.preserveIdent
        ? function (t) {
          if ("Enter" === t.key) {
            const e = w(), n = k();
            ...
            if (
              o.indentOn.test(e) && (i += o.tab),
                i.length > 0 ? (R(t), t.stopPropagation(), B("\n" + i)) : v(t),
        ...
        : v(e),
      o.catchTab && function (t) {
        if ("Tab" === t.key) {
          if (R(t), t.shiftKey) {
            const t = w();
            let [e, n] = K(t);
            if (e.length > 0) {
              const t = b(), r = Math.min(o.tab.length, e.length);
              E({ start: n, end: n + r }),
      ...
      o.addClosing && function (t) {
        const e = o.autoclose.open, n = o.autoclose.close;
        if (e.includes(t.key)) {
          R(t);
          const o = b(), r = o.start == o.end ? "" : _().toString();
          B(t.key + r + (n[e.indexOf(t.key)] ?? "")), o.start++, o.end++, E(o);
        }
      }(e),
      o.history && (!function (e) {
        if (S(e)) {
          R(e), c--;
          const n = a[c];
        ...
        if (A(e)) {
          R(e), c++;
          const n = a[c];
          n && (t.innerHTML = n.html, E(n.pos)), c >= a.length && c--;
        }
      }(e),
        m(e) && !N && (O(), N = !0)),
      g && !function (t) {
    ...
    T("keyup", (t) => {
      t.defaultPrevented || t.isComposing || (d !== P() && y(), C(t), f(P()));
    }),
    T("focus", (t) => {
      l = !0;
    }),
    ...
    T("cut", (e) => {
      O(),
        function (e) {
          const n = b(), o = _(), r = e.originalEvent ?? e;
